...
(function(a){
    a.fn.desSlideshow=function(p){
        ...
        var slideshow_height=p&&p.slideshow_height?p.slideshow_height:"480";
        var thumbnail_width=p&&p.thumbnail_width?p.thumbnail_width:"60";
        ...
        function init(){
            ...
            g.find(".switchBigPic").css("position","absolute");
            g.find(".switchBigPic").children("div").css("position","absolute").css("overflow","hidden");
            g.find(".switchBigPic").children("div").children("p").css("position","relative").css("padding","5px").css("margin","0px").css("bottom","0px").css("opacity","0.6").css("background-color","#000").css("color","#FFF").css("font-size","12px").css("width","100%");
            g.find(".nav").css("width",thumbnail_width).css("height",slideshow_height).css("position","absolute").css("left","0px");
            ...
            g.find(".nav").children("li").children("a").css("text-decoration","none").css("height","49px").css("display","block").css("padding-left","5px").css("font-size","10px");
        ...
        function showpic(){
            ...
            g.find(".nav").children("li").eq(current).animate({marginLeft: '-20px'}, "fast");
